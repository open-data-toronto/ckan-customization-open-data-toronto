...
def update_package(context):
    '''Ensures that changes to a resource in a package also affect
    ...
    for r in resources:
        ...
        # add possible last refreshed dates to array, sorted through below
    ...
    # make sure the package's last refreshed date is the latest last
    # refreshed date of its resources
    last_refreshed = (
